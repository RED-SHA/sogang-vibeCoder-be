...
public class ReportController {
    ...
    private final Map<String, DailyWorkReport> reportStore = new HashMap<>();
    ...
    public DailyWorkReportDTO submitReport(DailyWorkReportDTO dto) {
        guardNotClosedDown();
        if (dto == null || dto.getStaffId() == null || dto.getReportDate() == null) {
            throw new IllegalArgumentException("DailyWorkReport data is incomplete.");
        }
